...
<main class="main">
                        ...
                        <div class="product-slider-container">
                            <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                <div class="product-item">
                                    <img class="product-single-image" src="assets/images/products/zoom/product-1-big.jpg" data-zoom-image="assets/images/products/zoom/product-1-big.jpg" width="540" height="540" alt="product-img" />
                                </div>
                                <div class="product-item">
                                    <img class="product-single-image" src="assets/images/products/zoom/product-2-big.jpg" data-zoom-image="assets/images/products/zoom/product-2-big.jpg" width="540" height="540" alt="product-img" />
                                </div>
                                <div class="product-item">
                                    <img class="product-single-image" src="assets/images/products/zoom/product-3-big.jpg" data-zoom-image="assets/images/products/zoom/product-3-big.jpg" width="540" height="540" alt="product-img" />
                                </div>
                                <div class="product-item">
                                    <img class="product-single-image" src="assets/images/products/zoom/product-4-big.jpg" data-zoom-image="assets/images/products/zoom/product-4-big.jpg" width="540" height="540" alt="product-img" />
                                </div>
                            </div>
                ...
                <div class="col-xl-5 product-single-details pt-3">
                    ...
                    <div class="product-action">
                        ...
                        <div class="product-single-qty">
                            <input class="horizontal-quantity form-control bg-transparent" type="text">
                        </div>
                        <!-- End .product-single-qty -->

                        <a href="cart.html" class="btn btn-dark add-cart icon-shopping-cart mr-2" title="Add to Cart">Add to Cart</a>
    ...
    <div class="container">
        <div class="product-single-collapse mb-6" id="productAccordion">
            ...
            <div class="product-collapse-panel">
                <h3 class="product-collapse-title">
                    <a class="collapsed" data-toggle="collapse" href="#product-collapse-size" role="button" aria-expanded="false" aria-controls="product-collapse-size">Size Guide</a>
                </h3>

                <div class="product-collapse-body collapse" id="product-collapse-size" data-parent="#productAccordion">
                    <div class="collapse-body-wrapper pl-0">
            ...
            <div class="product-collapse-panel">
                <h3 class="product-collapse-title">
                    <a class="collapsed" data-toggle="collapse" href="#product-collapse-reviews" role="button" aria-expanded="false" aria-controls="product-collapse-reviews">Reviews (1)</a>
                </h3>
