      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <a href="{{ route('admin.brand.create') }}" class="btn btn-primary text-white me-0"><i class="fa fa-plus"></i> Create</a>
            ...
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="py-1">  {{ $brand->name }} </td>
                    <td>
                        <img src="{{asset('uploads/brand/').'/'.$brand->image}}" alt="" height='50' weight='50'>
                    </td>
                    <td> {{ $brand->status == 1 ? 'Active' : 'In Active' }} </td>
                    <td>
                      <a href="{{ route('admin.brand.edit', $brand->id) }}" class="btn btn-info btn-flat btn-sm"> <i class="fas fa-edit"></i></a>
