      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <a href="{{ route('admin.page.create') }}" class="btn btn-primary text-white me-0"><i class="fa fa-plus"></i> Create</a>
            ...
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="py-1">  {{ $page->title }} </td>
                    <td class="py-1">  {{ $page->content }} </td>
                    <td class="py-1">  {{ $page->description }} </td>

                    <td> {{ $page->status == 1 ? 'Active' : 'In Active' }} </td>
                    <td>
                      <a href="{{ route('admin.page.edit', $page->id) }}" class="btn btn-info btn-flat btn-sm"> <i class="fas fa-edit"></i></a>
