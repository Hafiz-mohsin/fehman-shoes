        ...
        <div class="card-body">
         ...
         <form action="{{ route('admin.product.update', $product->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input name="title" type="title" class="form-control" id="title" placeholder="title" value="{{ $product->title }}">
            </div>
            <div class="form-group">
                <label for="title">Short Description</label>
                <input name="short_decription" type="short_decription" class="form-control" id="short_decription" placeholder="Short Description" value="{{ $product->short_decription }}">
            </div>
            <div class="form-group">
                <label for="title">long Description</label>
                <input name="long_description" type="long_description" class="form-control" id="long_description" placeholder="long Description" value="{{ $product->long_description }}">
            </div>
            <div class="form-group">
                <label for="title">Price</label>
                <input name="price" type="price" class="form-control" id="price" placeholder="Price" value="{{ $product->price }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="type" type="type" class="form-control" id="type" placeholder="type" value="{{ $product->type }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <br>
                <img src="{{asset('uploads/product').'/'.$product->thumbnail}}" alt="" height='50' weight='50'>
            </div>
            <div class="form-group">
